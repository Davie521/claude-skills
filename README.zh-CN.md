...
Yifan 个人 Claude Code 插件市场 — **13 个 plugin / 117 个 skill**，覆盖开发工作流、设计、语言模式、测试、研究等。

## Plugin 总览

| Plugin | Skill 数 | 用途 |
|--------|---------|------|
| [`dev-workflow`](#dev-workflow) | 16 | Git PR 自动化、多 Agent 实现、蓝图、浏览器路由、**拷问、调试纪律、架构深化、issue triage、zoom-out 快捷键** |
...
- **`zoom-out`** — 一句话快捷键："上一层抽象，给我 module + caller 地图，用 CONTEXT.md 词汇"。仅手动触发（`disable-model-invocation: true`）
