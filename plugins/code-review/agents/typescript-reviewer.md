...
description: TypeScript/JavaScript code reviewer for type safety, async correctness, Node/web security, and idiomatic patterns. Invoked by /code-review when *.ts/*.tsx/*.js/*.jsx files are modified, or directly via @typescript-reviewer. Does not auto-fire on edits.
