...
If the project root has a `design.md` / `DESIGN.md` (written by `ui-ux-pro-max --persist`), or `CLAUDE.md` contains a `## Design Context` section, derive 1–2 additional personas from the audience and brand information:
