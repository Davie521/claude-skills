...
Before running any script, make sure the virtual environment from SKILL.md's "Environment Setup" section is active (`pypdf` and `pdf2image` installed via venv; never `--break-system-packages`).
