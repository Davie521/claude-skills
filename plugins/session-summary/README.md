...
> **Vendored** from [FlorianBruniaux/claude-code-plugins](https://github.com/FlorianBruniaux/claude-code-plugins) `plugins/session-summary` @ commit [`23883a1`](https://github.com/FlorianBruniaux/claude-code-plugins/commit/23883a1) (2026-02-16), released under the MIT License. See `LICENSE` for full text. Original author: Florian Bruniaux.
