...
**声音五维清单**（扩写前先对齐；有范文就从范文提取，没有就默认直接、具体、务实、少吹嘘）：
1. 句子长度与节奏
2. 语气：正式 / 口语 / 犀利
3. 惯用修辞：括号补充、清单、短句碎片、设问
4. 对幽默、个人观点、唱反调框架的接受度
5. 排版习惯：小标题、列表、代码块、引用块

**禁用词表**（出现即删改）：
- 套话开头："在当今快速发展的时代……"
- 填充过渡：滥用"此外"、"总而言之"（Moreover / Furthermore）
- 吹嘘词："颠覆性"、"游戏规则改变者"、"革命性"、"赋能"
- 没有论据支撑的空泛断言；上下文里没有依据的身份/成就背书
